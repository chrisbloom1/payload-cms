...
export function HeroFallback() {
  return (
    <div className="relative flex min-h-[712px] w-full flex-col items-center justify-center overflow-hidden px-4 pt-28 pb-16 text-center sm:min-h-[640px] sm:pt-32 sm:py-20 lg:min-h-[720px] lg:py-24">
