"use client"
// http-url:https://framerusercontent.com/modules/38LUtczqxjNBe1jStHKa/6TjKtpCik5GB5r2YlPDk/nStt1iZC_.js
...
var serializationHash2 = "framer-W9sAw";
var variantClassNames2 = {
  yoesFEDuD: "framer-v-19bwvj1"
};
var transition12 = {
  damping: 40,
  delay: 0,
...
var Component2 = React2.forwardRef(function (props, ref) {
  ...
  const qsrM5838n1nshjc1 = activeVariantCallback(async (...args) => {
    setVariant("yoesFEDuD");
  });
  ...
  return <LayoutGroup2 id={layoutId ?? defaultLayoutId}>{<Variants2 animate={variants} initial={false}>{<Transition2 value={transition12}>{_jsxs2(motion2.div, {
          ...restProps,
          ...gestureHandlers,
          className: cx2(scopingClassNames, "framer-19bwvj1", className3, classNames),
...
var css4 = ["@supports (aspect-ratio: 1) { body { --framer-aspect-ratio-supported: auto; } }", ".framer-W9sAw.framer-1a6g8t7, .framer-W9sAw .framer-1a6g8t7 { display: block; }", ".framer-W9sAw.framer-19bwvj1 { align-content: flex-start; align-items: flex-start; display: flex; flex-direction: column; flex-wrap: nowrap; gap: 0px; height: min-content; justify-content: flex-start; overflow: hidden; padding: 0px 20px 0px 20px; position: relative; width: 1000px; }", ".framer-W9sAw .framer-1jmjdfd-container, .framer-W9sAw .framer-119dd2r-container, .framer-W9sAw .framer-kupcfo-container, .framer-W9sAw .framer-10s47vu-container, .framer-W9sAw .framer-ue8ny5-container, .framer-W9sAw .framer-ivfwlp-container, .framer-W9sAw .framer-10gxl72-container, .framer-W9sAw .framer-1r3m2qr-container { flex: none; height: auto; position: relative; width: 100%; }"];
var FramernStt1iZC_ = withCSS2(Component2, css4, "framer-W9sAw");
var nStt1iZC_default = FramernStt1iZC_;
FramernStt1iZC_.displayName = "faq-providers";
FramernStt1iZC_.defaultProps = {
  height: 742.5,
  width: 1e3
};
addFonts2(FramernStt1iZC_, [{
  explicitInter: true,
  fonts: []
}, ...RowFonts], {
  supportsExplicitInterCodegen: true
...
var _OriginalComponent = nStt1iZC_default;
function FaqprovidersWrapped(props) {
...
Object.assign(FaqprovidersWrapped, _OriginalComponent);
export {  __FramerMetadata__,  FaqprovidersWrapped as default   };