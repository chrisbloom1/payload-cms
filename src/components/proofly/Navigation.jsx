"use client"
// http-url:https://framerusercontent.com/modules/wwvWmwkrpxfEFyciPjg6/wB0UmmAo0TdSpdyufFXz/Th8W3E3rh.js
...
var css = [".framer-rlzko .framer-styles-preset-ickepd:not(.rich-text-wrapper), .framer-rlzko .framer-styles-preset-ickepd.rich-text-wrapper a { --framer-link-current-text-decoration: underline; --framer-link-hover-text-decoration: underline; }"];
var className = "framer-rlzko";
...
var cycleOrder2 = ["vcWMlJSfN", "xuqUELMWu", "R50E7NhDe", "UkfIzKmy0"];
var serializationHash2 = "framer-OdfFv";
var variantClassNames2 = {
  R50E7NhDe: "framer-v-7pjpwz",
  UkfIzKmy0: "framer-v-10oxnak",
  vcWMlJSfN: "framer-v-1m0jjrg",
  xuqUELMWu: "framer-v-14wfehx"
};
...
var getProps3 = ({
  ...
  return {
    ...props,
    variant: humanReadableVariantMap2[props.variant] ?? props.variant ?? "vcWMlJSfN"
  };
};
...
var Component3 = React3.forwardRef(function (props, ref) {
  ...
  const onTap138wp6m = activeVariantCallback(async (...args) => {
    setVariant("R50E7NhDe");
  });
  const onTapi42xos = activeVariantCallback(async (...args) => {
    setVariant("xuqUELMWu");
  });
  const sharedStyleClassNames = [className];
  const scopingClassNames = cx3(serializationHash2, ...sharedStyleClassNames);
  const isDisplayed = () => {
    if (["xuqUELMWu", "R50E7NhDe"].includes(baseVariant)) return true;
    return false;
  };
  const isDisplayed1 = () => {
    if (baseVariant === "xuqUELMWu") return false;
    return true;
  };
  return <LayoutGroup2 id={layoutId ?? defaultLayoutId}>{<Variants2 animate={variants} initial={false}>{<Transition2 value={transition2}>{<MotionNavWithFX {...restProps} {...gestureHandlers} __framer__animate={{
          ...
          direction: "down",
          target: animation
        }} __framer__styleAppearEffectEnabled __framer__threshold={0.5} __perspectiveFX={false} __smartComponentFX __targetOpacity={1} className={cx3(scopingClassNames, "framer-1m0jjrg", className4, classNames)} data-framer-name="Desktop" layoutDependency={layoutDependency} layoutId="vcWMlJSfN" ref={refBinding} style={{
          ...style
          ...
          xuqUELMWu: {
            ...
            className: "framer-hdly0a",
            layoutDependency,
            layoutId: "GSjvo1i7H",
            style: {
              backdropFilter: "blur(10px)",
              backgroundColor: "rgba(235, 235, 240, 0.8)",
            ...
            children: [_jsxs2(motion3.div, {
              className: "framer-1p8hdyc",
              "data-framer-name": "Top",
              layoutDependency,
              layoutId: "EPDIshgd8",
              children: [isDisplayed() && _jsxs2(motion3.div, {
                className: "framer-1ibza3j",
                ...
                webPageId: "tExHQbrzG"
              }} motionChild nodeId="ZAWJs5ltP" openInNewTab={false} scopeId="Th8W3E3rh">{<SVG2 as="a" className="framer-ufuuzx framer-1xiapll" data-framer-name="Graphic" layout="position" layoutDependency={layoutDependency} layoutId="ZAWJs5ltP" opacity={1} svg={__svg_2} svgContentId={10962988141} withExternalLayout />}</Link2>]
            }), isDisplayed1() && <MotionDivWithFXWithOptimizedAppearEffect className="framer-zbq3lh" data-framer-appear-id="zbq3lh" layoutDependency={layoutDependency} layoutId="iBDx13UYD" {...addPropertyOverrides2({
              R50E7NhDe: {
            ...
            }, baseVariant, gestureVariant)}>{<RichText2 __fromCanvasComponent className="framer-1811vl3" fonts={["CUSTOM;Haffer Bold"]} layoutDependency={layoutDependency} layoutId="tTAoToAwM" style={{
                ...
                R50E7NhDe: {
                  children: <React3.Fragment>{_jsx3(motion3.p, {
                      ...
                      children: <Link2 href={{
                        webPageId: "XzIlki2Ym"
                      }} motionChild nodeId="tTAoToAwM" openInNewTab={false} relValues={[]} scopeId="Th8W3E3rh" smoothScroll={false}>{_jsx3(motion3.a, {
                          className: "framer-styles-preset-ickepd",
                          "data-styles-preset": "zBEYOcNVl",
                          children: "Brands"
                        })}</Link2>
                    })}</React3.Fragment>
                }
                  ...
                  })}</React3.Fragment>}</RichText2>}{<RichText2 __fromCanvasComponent className="framer-t375dc" fonts={["CUSTOM;Haffer Bold"]} layoutDependency={layoutDependency} layoutId="UiIXai8OH" style={{
                "--extracted-r6o4lv": "var(--token-7d27c033-cb66-44c8-bf4e-e66d9f19511b, rgb(34, 23, 66))"
              }} verticalAlignment="top" withExternalLayout {...addPropertyOverrides2({
                R50E7NhDe: {
                  children: <React3.Fragment>{_jsx3(motion3.p, {
                      ...
                      children: <Link2 href={{
                        webPageId: "s2mtaO1Iz"
                      }} motionChild nodeId="UiIXai8OH" openInNewTab={false} relValues={[]} scopeId="Th8W3E3rh" smoothScroll={false}>{_jsx3(motion3.a, {
                          className: "framer-styles-preset-ickepd",
                          "data-styles-preset": "zBEYOcNVl",
                          children: "Providers"
                        })}</Link2>
                  ...
                  })}</React3.Fragment>}</RichText2>}{<RichText2 __fromCanvasComponent className="framer-dybejm" fonts={["CUSTOM;Haffer Bold"]} layoutDependency={layoutDependency} layoutId="evsabsCez" style={{
                "--extracted-r6o4lv": "var(--token-7d27c033-cb66-44c8-bf4e-e66d9f19511b, rgb(34, 23, 66))"
              }} verticalAlignment="top" withExternalLayout {...addPropertyOverrides2({
                R50E7NhDe: {
                  children: <React3.Fragment>{_jsx3(motion3.p, {
                      ...
                      children: <Link2 href={{
                        webPageId: "Qy9zYxbIQ"
                      }} motionChild nodeId="evsabsCez" openInNewTab={false} relValues={[]} scopeId="Th8W3E3rh" smoothScroll={false}>{_jsx3(motion3.a, {
                          className: "framer-styles-preset-ickepd",
                          "data-styles-preset": "zBEYOcNVl",
                          children: "Stories"
                        })}</Link2>
                  ...
                  })}</React3.Fragment>}</RichText2>}</MotionDivWithFXWithOptimizedAppearEffect>, isDisplayed1() && <MotionDivWithFXWithOptimizedAppearEffect className="framer-kltfjp" data-framer-appear-id="kltfjp" layoutDependency={layoutDependency} layoutId="PAMpojkQ8" {...addPropertyOverrides2({
              R50E7NhDe: {
                __perspectiveFX: false,
                __smartComponentFX: true,
                __targetOpacity: 1,
            ...
            }, baseVariant, gestureVariant)}>{<ComponentViewportProvider height={45} y={(componentViewport?.y || 0) + (12 + ((componentViewport?.height || 96) - 24 - 72) / 2) + 13.5 + 0} {...addPropertyOverrides2({
                R50E7NhDe: {
                  y: (componentViewport?.y || 0) + 16 + 0 + 0 + (0 + (68 + Math.max(0, (Math.max(0, ((componentViewport?.height || 720) - 32 - 0) / 1) * 1 - 0 - 248) / 1) * 1) + (Math.max(0, ((componentViewport?.height || 720) - 32 - 0) / 1) * 1 - 0 - (68 + Math.max(0, (Math.max(0, ((componentViewport?.height || 720) - 32 - 0) / 1) * 1 - 0 - 248) / 1) * 1 + 180)) / 2 * 2) + 16 + 0
                }
              }, baseVariant, gestureVariant)}>{<SmartComponentScopedContainer className="framer-1a71i1r-container" layoutDependency={layoutDependency} layoutId="eeE6Oi5Nt-container" nodeId="eeE6Oi5Nt" rendersWithMotion scopeId="Th8W3E3rh">{_jsx3(yZBQGZIRL_default, {
                    height: "100%",
                    id: "eeE6Oi5Nt",
                    KhVtTQLb4: "4px",
                    layoutId: "eeE6Oi5Nt",
                    P7ZHYgc9n: "var(--token-fc055746-14f5-4ad8-a648-dc72569c723d, rgb(246, 246, 248))",
                    qzxtK1_9Y: "welcome.bloomnetwork.ai",
                    RQDpSij6V: "var(--token-d29c90a1-1235-46d8-abcf-63afa67478e3, rgb(254, 5, 62))",
                    TiAMtDaz3: "Get Started",
                    variant: matchVariant("coXNANDm3"),
                    width: "100%",
                    wN3STPwMb: {
                      borderColor: "var(--token-7d27c033-cb66-44c8-bf4e-e66d9f19511b, rgb(34, 23, 66))",
                      borderStyle: "solid",
                  ...
                  })}</SmartComponentScopedContainer>}</ComponentViewportProvider>}{<ComponentViewportProvider height={45} y={(componentViewport?.y || 0) + (12 + ((componentViewport?.height || 96) - 24 - 72) / 2) + 13.5 + 0} {...addPropertyOverrides2({
                R50E7NhDe: {
                  y: (componentViewport?.y || 0) + 16 + 0 + 0 + (0 + (68 + Math.max(0, (Math.max(0, ((componentViewport?.height || 720) - 32 - 0) / 1) * 1 - 0 - 248) / 1) * 1) + (Math.max(0, ((componentViewport?.height || 720) - 32 - 0) / 1) * 1 - 0 - (68 + Math.max(0, (Math.max(0, ((componentViewport?.height || 720) - 32 - 0) / 1) * 1 - 0 - 248) / 1) * 1 + 180)) / 2 * 2) + 16 + 55
                }
              }, baseVariant, gestureVariant)}>{<SmartComponentScopedContainerWithFXWithOptimizedAppearEffect className="framer-15wh8f4-container" data-framer-appear-id="15wh8f4" layoutDependency={layoutDependency} layoutId="KKXGrss2A-container" nodeId="KKXGrss2A" rendersWithMotion scopeId="Th8W3E3rh" {...addPropertyOverrides2({
                  R50E7NhDe: {
                    __perspectiveFX: false,
                    __smartComponentFX: true,
                    __targetOpacity: 1,
                    ...
                    KhVtTQLb4: "4px",
                    layoutId: "KKXGrss2A",
                    P7ZHYgc9n: "var(--token-7d27c033-cb66-44c8-bf4e-e66d9f19511b, rgb(34, 23, 66))",
...
var css6 = ["@supports (aspect-ratio: 1) { body { --framer-aspect-ratio-supported: auto; } }", ".framer-OdfFv.framer-1xiapll, .framer-OdfFv .framer-1xiapll { display: block; }", ".framer-OdfFv.framer-1m0jjrg { align-content: center; align-items: center; display: flex; flex-direction: row; flex-wrap: nowrap; gap: 20px; height: min-content; justify-content: center; overflow: hidden; padding: 12px; position: relative; width: 1200px; }", ".framer-OdfFv .framer-hdly0a { align-content: center; align-items: center; display: flex; flex: 1 0 0px; flex-direction: row; flex-wrap: nowrap; height: min-content; justify-content: space-between; max-width: 1280px; overflow: visible; padding: 12px 12px 12px 24px; position: relative; width: 1px; }", ".framer-OdfFv .framer-1p8hdyc { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 0px; height: min-content; justify-content: center; overflow: visible; padding: 10px 0px 10px 0px; position: relative; width: min-content; }", ".framer-OdfFv .framer-1ibza3j { flex: none; height: 40px; overflow: hidden; position: relative; width: 40px; }", ".framer-OdfFv .framer-gr0j4b { flex: none; height: 2px; left: calc(50.00000000000002% - 20px / 2); overflow: hidden; position: absolute; top: calc(62.50000000000002% - 2px / 2); width: 20px; will-change: var(--framer-will-change-override, transform); }", ".framer-OdfFv .framer-1untot2 { flex: none; height: 2px; left: calc(50.00000000000002% - 20px / 2); overflow: hidden; position: absolute; top: calc(37.50000000000002% - 2px / 2); width: 20px; will-change: var(--framer-will-change-override, transform); }", ".framer-OdfFv .framer-ufuuzx { flex: none; height: 28px; position: relative; text-decoration: none; width: 126px; }", ".framer-OdfFv .framer-zbq3lh { align-content: center; align-items: center; display: flex; flex: 1 0 0px; flex-direction: row; flex-wrap: nowrap; gap: 16px; height: min-content; justify-content: center; overflow: visible; padding: 0px; position: relative; width: 1px; }", ".framer-OdfFv .framer-1811vl3, .framer-OdfFv .framer-t375dc, .framer-OdfFv .framer-dybejm { flex: none; height: auto; position: relative; white-space: pre; width: auto; }", ".framer-OdfFv .framer-kltfjp { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: min-content; justify-content: center; overflow: visible; padding: 0px; position: relative; width: min-content; }", ".framer-OdfFv .framer-1a71i1r-container, .framer-OdfFv .framer-15wh8f4-container { flex: none; height: auto; position: relative; width: auto; }", ".framer-OdfFv.framer-v-14wfehx.framer-1m0jjrg { flex-direction: column; gap: 0px; padding: 16px 8px 16px 8px; width: 390px; }", ".framer-OdfFv.framer-v-14wfehx .framer-hdly0a { flex: none; padding: 12px; width: 100%; }", ".framer-OdfFv.framer-v-14wfehx .framer-1p8hdyc { flex: 1 0 0px; gap: unset; justify-content: space-between; padding: 0px; width: 1px; }", ".framer-OdfFv.framer-v-14wfehx .framer-1ibza3j, .framer-OdfFv.framer-v-7pjpwz .framer-1ibza3j { cursor: pointer; height: 44px; order: 1; width: 44px; }", ".framer-OdfFv.framer-v-14wfehx .framer-ufuuzx, .framer-OdfFv.framer-v-7pjpwz .framer-ufuuzx { order: 0; }", ".framer-OdfFv.framer-v-7pjpwz.framer-1m0jjrg { align-content: flex-start; align-items: flex-start; flex-direction: column; gap: 0px; height: 1200px; justify-content: flex-start; max-height: calc(var(--framer-viewport-height, 100vh) * 1); min-height: calc(var(--framer-viewport-height, 100vh) * 1); overflow: auto; overscroll-behavior: contain; padding: 16px 8px 16px 8px; width: 390px; }", ".framer-OdfFv.framer-v-7pjpwz .framer-hdly0a { align-content: flex-start; align-items: flex-start; flex-direction: column; height: 1px; padding: 0px; width: 100%; }", ".framer-OdfFv.framer-v-7pjpwz .framer-1p8hdyc { gap: unset; justify-content: space-between; padding: 12px; width: 100%; }", ".framer-OdfFv.framer-v-7pjpwz .framer-gr0j4b, .framer-OdfFv.framer-v-7pjpwz .framer-1untot2 { top: calc(50.00000000000002% - 2px / 2); }", ".framer-OdfFv.framer-v-7pjpwz .framer-zbq3lh { flex-direction: column; gap: 64px; height: 1px; padding: 24px; width: 100%; }", ".framer-OdfFv.framer-v-7pjpwz .framer-kltfjp { flex-direction: column; padding: 16px 16px 64px 16px; width: 100%; }", ...css];
var FramerTh8W3E3rh = withCSS3(Component3, css6, "framer-OdfFv");
var Th8W3E3rh_default = FramerTh8W3E3rh;
FramerTh8W3E3rh.displayName = "Navigation";
FramerTh8W3E3rh.defaultProps = {
  height: 96,
  width: 1200
};
addPropertyControls3(FramerTh8W3E3rh, {
  variant: {
    options: ["vcWMlJSfN", "xuqUELMWu", "R50E7NhDe", "UkfIzKmy0"],
    optionTitles: ["Desktop", "Phone", "Phone Open", "Laptop"],
    title: "Variant",
    type: ControlType3.Enum
  }
});
addFonts2(FramerTh8W3E3rh, [{
  explicitInter: true,
  fonts: [{
    cssFamilyName: "Haffer Bold",
    source: "custom",
  ...
  "exports": {
    "default": {
      ...
      "annotations": {
        ...
        "framerCanvasComponentVariantDetails": '{"propertyName":"variant","data":{"default":{"layout":["fixed","auto"]},"xuqUELMWu":{"layout":["fixed","auto"]},"R50E7NhDe":{"layout":["fixed","fixed"],"constraints":[null,null,"100vh","100vh"]},"UkfIzKmy0":{"layout":["fixed","auto"]}}}',
...
var _OriginalComponent = Th8W3E3rh_default;
function NavigationWrapped(props) {
...
Object.assign(NavigationWrapped, _OriginalComponent);
export {  __FramerMetadata__,  NavigationWrapped as default   };