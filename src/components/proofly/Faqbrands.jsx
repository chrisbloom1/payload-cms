"use client"
// http-url:https://framerusercontent.com/modules/YB1A5lBnUryGZhnqUBnk/KmdZGomYv4vfA8bqlCFU/OZDv0HSq8.js
...
var serializationHash2 = "framer-ePojY";
var variantClassNames2 = {
  UOd8vM1uQ: "framer-v-11c3nk6"
};
var transition12 = {
  damping: 40,
  delay: 0,
...
var Component2 = React2.forwardRef(function (props, ref) {
  ...
  const qsrM5838n4fzyai = activeVariantCallback(async (...args) => {
    setVariant("UOd8vM1uQ");
  });
  ...
  return <LayoutGroup2 id={layoutId ?? defaultLayoutId}>{<Variants2 animate={variants} initial={false}>{<Transition2 value={transition12}>{_jsxs2(motion2.div, {
          ...restProps,
          ...gestureHandlers,
          className: cx2(scopingClassNames, "framer-11c3nk6", className3, classNames),
...
var css4 = ["@supports (aspect-ratio: 1) { body { --framer-aspect-ratio-supported: auto; } }", ".framer-ePojY.framer-1c9aw12, .framer-ePojY .framer-1c9aw12 { display: block; }", ".framer-ePojY.framer-11c3nk6 { align-content: flex-start; align-items: flex-start; display: flex; flex-direction: column; flex-wrap: nowrap; gap: 0px; height: min-content; justify-content: flex-start; overflow: hidden; padding: 0px 20px 0px 20px; position: relative; width: 1000px; }", ".framer-ePojY .framer-11nc9mv-container, .framer-ePojY .framer-1wao4ro-container, .framer-ePojY .framer-13qz9jq-container, .framer-ePojY .framer-r8z9z3-container, .framer-ePojY .framer-2pn7rr-container, .framer-ePojY .framer-1t2k21z-container, .framer-ePojY .framer-777ter-container, .framer-ePojY .framer-122e8ow-container { flex: none; height: auto; position: relative; width: 100%; }"];
var FramerOZDv0HSq8 = withCSS2(Component2, css4, "framer-ePojY");
var OZDv0HSq8_default = FramerOZDv0HSq8;
FramerOZDv0HSq8.displayName = "faq-brands";
FramerOZDv0HSq8.defaultProps = {
  height: 742.5,
  width: 1e3
};
addFonts2(FramerOZDv0HSq8, [{
  explicitInter: true,
  fonts: []
}, ...RowFonts], {
  supportsExplicitInterCodegen: true
...
var _OriginalComponent = OZDv0HSq8_default;
function FaqbrandsWrapped(props) {
...
Object.assign(FaqbrandsWrapped, _OriginalComponent);
export {  __FramerMetadata__,  FaqbrandsWrapped as default   };