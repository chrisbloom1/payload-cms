...
var Component = React3.forwardRef(function (props, ref) {
  ...
  return <LayoutGroup id={layoutId ?? defaultLayoutId}>{<Variants animate={variants} initial={false}>{<Transition value={transition1}>{_jsxs(motion2.div, {
          ...restProps,
          ...gestureHandlers,
          className: cx(serializationHash, ...sharedStyleClassNames, "framer-zq57kp", className2, classNames),
          "data-framer-name": "no",
          layoutDependency,
          layoutId: "yqVL7bhyU",
          ref: ref ?? ref1,
  ...
  "exports": {
    "default": {
      ...
      "annotations": {
        ...
        "framerCanvasComponentVariantDetails": '{"propertyName":"variant","data":{"default":{"layout":["fixed","auto"]},"VURHk1q7I":{"layout":["fixed","auto"]}}}',
        "framerVariables": '{"inSq_WnrT":"title","VMnWb3StF":"iconColor","B8e5giMAo":"textColor","PiExLueGf":"iconPadding"}'
      }
    },
    "Props": {
      "type": "tsType",
...
var _OriginalComponent = P6yU1EFQs_default;
function PricingFeaturesWrapped(props) {
...
Object.assign(PricingFeaturesWrapped, _OriginalComponent);
export {  __FramerMetadata__,  PricingFeaturesWrapped as default   };