"use client"
// http-url:https://framerusercontent.com/modules/8vlobtcEqDPl7VqGrenN/13zQe3XbTITCw8yUIJHl/LPvlGYrGE.js
import { jsx as _jsx3, jsxs as _jsxs } from "react/jsx-runtime";
import { addFonts, addPropertyControls as addPropertyControls2, ComponentViewportProvider, ControlType as ControlType3, cx, getFonts, getFontsFromSharedStyle, getLoadingLazyAtYPosition, Image, RichText, useActiveVariantCallback, useComponentViewport, useLocaleInfo, useVariantState, withCSS } from "@proofly-framer/runtime";
...
var cycleOrder = ["hbrEbixPO", "Tc9JFPlP7"];
var serializationHash = "framer-6h060";
var variantClassNames = {
  hbrEbixPO: "framer-v-qdunhf",
  Tc9JFPlP7: "framer-v-1win52g"
};
...
var getProps = ({
  ...
  return {
    ...props,
    variant: humanReadableVariantMap[props.variant] ?? props.variant ?? "hbrEbixPO"
  };
};
...
var Component = React3.forwardRef(function (props, ref) {
  ...
  const onTap5tcxe4 = activeVariantCallback(async (...args) => {
    setVariant("hbrEbixPO");
  });
  const onTapq2sk2g = activeVariantCallback(async (...args) => {
    setVariant("Tc9JFPlP7");
  });
  const ref1 = React3.useRef(null);
  const defaultLayoutId = React3.useId();
  const sharedStyleClassNames = [className2, className3, className];
  const componentViewport = useComponentViewport();
  return <LayoutGroup id={layoutId ?? defaultLayoutId}>{<Variants animate={variants} initial={false}>{<Transition value={transition1}>{_jsx3(motion2.div, {
          ...restProps,
          ...gestureHandlers,
          className: cx(serializationHash, ...sharedStyleClassNames, "framer-qdunhf", className4, classNames),
          "data-border": true,
          ...
          children: _jsx3(motion2.div, {
            ...
            children: _jsxs(motion2.div, {
              className: "framer-rmjamw",
              "data-framer-name": "content-txt",
              layoutDependency,
              layoutId: "azk8GtD70",
              children: [_jsx3(motion2.div, {
                className: "framer-8uhskj",
                ...
                children: <Image background={{
                  alt: "",
                  fit: "fill",
                  intrinsicHeight: 18.5,
                  intrinsicWidth: 150,
                  loading: getLoadingLazyAtYPosition((componentViewport?.y || 0) + (40 + ((componentViewport?.height || 468) - 80 - ((componentViewport?.height || 468) - 80) * 1) / 2) + (0 + (((componentViewport?.height || 468) - 80) * 1 - 0 - (((componentViewport?.height || 468) - 80) * 1 - 0) * 1) / 2) + 0 + (0 + 0 + ((((componentViewport?.height || 468) - 80) * 1 - 0) * 1 - 0 - 127) / 2 * 0) + 0),
                  pixelHeight: 37,
                  pixelWidth: 300,
                  src: "https://framerusercontent.com/images/opaGLr4lTQZmYlDlOHwVVghqIg.png"
                }} className="framer-y1ma31" data-framer-name="Image" layoutDependency={layoutDependency} layoutId="Gk4Pc52XY" />
              }), _jsx3(motion2.div, {
                className: "framer-jg76r1",
                "data-framer-name": "name 2",
                layoutDependency,
                layoutId: "fdeyRAjlL",
                children: <RichText __fromCanvasComponent className="framer-dlgv41" data-framer-name="Supporting text" fonts={["Inter"]} layoutDependency={layoutDependency} layoutId="sptA61T6b" style={{
                  "--framer-paragraph-spacing": "18px"
                }} verticalAlignment="top" withExternalLayout {...addPropertyOverrides({
                  Tc9JFPlP7: {
                    children: <React3.Fragment>{_jsxs(motion2.h3, {
                        className: "framer-styles-preset-19ujo0x",
                        "data-styles-preset": "UrNHzCTiy",
                        style: {
                          "--framer-text-alignment": "left"
                        },
                        children: ["tes", _jsx3(motion2.br, {}), "tes", _jsx3(motion2.br, {}), "test", _jsx3(motion2.br, {}), "test"]
                      })}</React3.Fragment>,
                    effect: textEffect
                  }
                }, baseVariant, gestureVariant)}>{<React3.Fragment>{_jsx3(motion2.h3, {
                      className: "framer-styles-preset-19ujo0x",
                      "data-styles-preset": "UrNHzCTiy",
                      style: {
                        "--framer-text-alignment": "left"
                ...
                className: "framer-pcsrth",
                "data-framer-name": "author",
                layoutDependency,
                layoutId: "NDYDAEKRw",
                children: [_jsxs(motion2.div, {
                  className: "framer-iupoi7",
                  "data-framer-name": "author",
                  layoutDependency,
                  layoutId: "TImHWxnwE",
                  children: [<Image background={{
                    alt: "",
                    fit: "fill",
                    loading: getLoadingLazyAtYPosition((componentViewport?.y || 0) + (40 + ((componentViewport?.height || 468) - 80 - ((componentViewport?.height || 468) - 80) * 1) / 2) + (0 + (((componentViewport?.height || 468) - 80) * 1 - 0 - (((componentViewport?.height || 468) - 80) * 1 - 0) * 1) / 2) + 0 + (0 + 67 + ((((componentViewport?.height || 468) - 80) * 1 - 0) * 1 - 0 - 127) / 2 * 2) + 0 + 0),
                    src: "https://framerusercontent.com/images/HhgNAZmatUa4AGMpAcoVdO1xU.png"
                  }} className="framer-txp75y" data-framer-name="Persons" layoutDependency={layoutDependency} layoutId="ANWsfH4mo" style={{
                    borderBottomLeftRadius: 80,
                    borderBottomRightRadius: 80,
                    borderTopLeftRadius: 80,
                    borderTopRightRadius: 80
                  }} />, _jsxs(motion2.div, {
                    className: "framer-c7tmsx",
                    "data-framer-name": "name",
                    layoutDependency,
                    layoutId: "zHyg4X6sT",
                    children: [<RichText __fromCanvasComponent className="framer-fabcmi" data-framer-name="Heading5" fonts={["Inter"]} layoutDependency={layoutDependency} layoutId="GUO2gwEGR" style={{
                      "--framer-paragraph-spacing": "0px"
                    }} verticalAlignment="top" withExternalLayout>{<React3.Fragment>{_jsx3(motion2.h5, {
                          className: "framer-styles-preset-1e98430",
                          "data-styles-preset": "z4Urx0kPV",
                          children: "Colin Godby"
                        })}</React3.Fragment>}</RichText>, <RichText __fromCanvasComponent className="framer-1gwifje" data-framer-name="Subtitle2" fonts={["Inter"]} layoutDependency={layoutDependency} layoutId="HPCqPn_gV" style={{
                      "--extracted-r6o4lv": "var(--token-00177e2c-b71a-4918-aaf7-10f1a0f84aad, rgb(224, 224, 255))",
                      "--framer-paragraph-spacing": "0px"
                    }} verticalAlignment="top" withExternalLayout>{<React3.Fragment>{_jsx3(motion2.p, {
                  ...
                  className: "framer-2rfnbn",
                  "data-framer-name": "arrows",
                  layoutDependency,
                  layoutId: "QMgFyDacR",
                  children: [_jsx3(motion2.div, {
                    className: "framer-azi4t8",
                    "data-border": true,
                    ...
                    children: <ComponentViewportProvider>{_jsx3(motion2.div, {
                        className: "framer-1sjm7t2-container",
                        layoutDependency,
                        layoutId: "JeRhTRkMZ-container",
                        children: <Icon color="rgba(255, 255, 255, 0.5)" height="100%" iconSearch="Home" iconSelection="ArrowBack" iconStyle15="Filled" iconStyle2="Filled" iconStyle7="Filled" id="JeRhTRkMZ" layoutId="JeRhTRkMZ" mirrored={false} selectByList style={{
                          height: "100%",
                          width: "100%"
                        }} width="100%" />
                      })}</ComponentViewportProvider>
                  }), _jsx3(motion2.div, {
                    className: "framer-r1xwzv",
                    ...
                    onTap: onTapq2sk2g,
                    style: {
                      backgroundColor: "var(--token-b775f3a4-6988-4082-a007-c0b15addc29b, rgb(255, 255, 255))",
                      borderBottomLeftRadius: 64,
                      borderBottomRightRadius: 64,
                      borderTopLeftRadius: 64,
                      borderTopRightRadius: 64
                    ...
                    children: <ComponentViewportProvider>{_jsx3(motion2.div, {
                        className: "framer-k12hfp-container",
                        layoutDependency,
                        layoutId: "X4fTy1tf8-container",
                        style: {
                          rotate: 180
                        },
                        children: <Icon color="var(--token-c043a581-21f0-4f3b-a91f-233b971f6cc2, rgb(36, 52, 62))" height="100%" iconSearch="Home" iconSelection="ArrowBack" iconStyle15="Filled" iconStyle2="Filled" iconStyle7="Filled" id="X4fTy1tf8" layoutId="X4fTy1tf8" mirrored={false} selectByList style={{
                          height: "100%",
                          width: "100%"
                        }} width="100%" />
                      })}</ComponentViewportProvider>
...
var css4 = ["@supports (aspect-ratio: 1) { body { --framer-aspect-ratio-supported: auto; } }", ".framer-6h060.framer-elk2bo, .framer-6h060 .framer-elk2bo { display: block; }", ".framer-6h060.framer-qdunhf { align-content: center; align-items: center; display: flex; flex-direction: row; flex-wrap: nowrap; gap: 72px; height: 468px; justify-content: center; overflow: hidden; padding: 40px 80px 40px 80px; position: relative; width: 1024px; will-change: var(--framer-will-change-override, transform); }", ".framer-6h060 .framer-rdx5i6 { align-content: center; align-items: center; display: flex; flex: 1 0 0px; flex-direction: row; flex-wrap: nowrap; gap: 0px; height: 100%; justify-content: center; overflow: visible; padding: 0px; position: relative; width: 1px; }", ".framer-6h060 .framer-rmjamw { align-content: flex-start; align-items: flex-start; display: flex; flex: 1 0 0px; flex-direction: column; flex-wrap: nowrap; height: 100%; justify-content: space-between; overflow: visible; padding: 0px; position: relative; width: 1px; }", ".framer-6h060 .framer-8uhskj { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: min-content; justify-content: flex-start; overflow: visible; padding: 0px; position: relative; width: 100%; }", ".framer-6h060 .framer-y1ma31 { aspect-ratio: 8.108108108108109 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 19px); overflow: visible; position: relative; width: 150px; }", ".framer-6h060 .framer-jg76r1 { align-content: flex-start; align-items: flex-start; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: min-content; justify-content: flex-start; overflow: visible; padding: 0px; position: relative; width: 100%; }", ".framer-6h060 .framer-dlgv41 { flex: none; height: auto; position: relative; white-space: pre-wrap; width: 100%; word-break: break-word; word-wrap: break-word; }", ".framer-6h060 .framer-pcsrth { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; height: min-content; justify-content: space-between; overflow: visible; padding: 0px; position: relative; width: 100%; }", ".framer-6h060 .framer-iupoi7 { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 16px; height: min-content; justify-content: flex-start; overflow: visible; padding: 0px; position: relative; width: min-content; }", ".framer-6h060 .framer-txp75y { aspect-ratio: 1 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 60px); overflow: hidden; position: relative; width: 60px; will-change: var(--framer-will-change-override, transform); }", ".framer-6h060 .framer-c7tmsx { align-content: flex-start; align-items: flex-start; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 0px; height: min-content; justify-content: flex-start; overflow: visible; padding: 0px; position: relative; width: min-content; }", ".framer-6h060 .framer-fabcmi, .framer-6h060 .framer-1gwifje { flex: none; height: auto; position: relative; white-space: pre; width: auto; }", ".framer-6h060 .framer-2rfnbn { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: min-content; justify-content: flex-end; overflow: hidden; padding: 0px; position: relative; width: min-content; z-index: 1; }", ".framer-6h060 .framer-azi4t8 { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: 48px; justify-content: center; overflow: hidden; padding: 0px; position: relative; width: 48px; will-change: var(--framer-will-change-override, transform); }", ".framer-6h060 .framer-1sjm7t2-container, .framer-6h060 .framer-k12hfp-container { flex: none; height: 24px; position: relative; width: 24px; }", ".framer-6h060 .framer-r1xwzv { align-content: center; align-items: center; cursor: pointer; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: 48px; justify-content: center; overflow: hidden; padding: 0px; position: relative; width: 48px; will-change: var(--framer-will-change-override, transform); }", "@supports (background: -webkit-named-image(i)) and (not (font-palette:dark)) { .framer-6h060.framer-qdunhf, .framer-6h060 .framer-rdx5i6, .framer-6h060 .framer-8uhskj, .framer-6h060 .framer-jg76r1, .framer-6h060 .framer-iupoi7, .framer-6h060 .framer-c7tmsx, .framer-6h060 .framer-2rfnbn, .framer-6h060 .framer-azi4t8, .framer-6h060 .framer-r1xwzv { gap: 0px; } .framer-6h060.framer-qdunhf > * { margin: 0px; margin-left: calc(72px / 2); margin-right: calc(72px / 2); } .framer-6h060.framer-qdunhf > :first-child, .framer-6h060 .framer-rdx5i6 > :first-child, .framer-6h060 .framer-8uhskj > :first-child, .framer-6h060 .framer-jg76r1 > :first-child, .framer-6h060 .framer-iupoi7 > :first-child, .framer-6h060 .framer-2rfnbn > :first-child, .framer-6h060 .framer-azi4t8 > :first-child, .framer-6h060 .framer-r1xwzv > :first-child { margin-left: 0px; } .framer-6h060.framer-qdunhf > :last-child, .framer-6h060 .framer-rdx5i6 > :last-child, .framer-6h060 .framer-8uhskj > :last-child, .framer-6h060 .framer-jg76r1 > :last-child, .framer-6h060 .framer-iupoi7 > :last-child, .framer-6h060 .framer-2rfnbn > :last-child, .framer-6h060 .framer-azi4t8 > :last-child, .framer-6h060 .framer-r1xwzv > :last-child { margin-right: 0px; } .framer-6h060 .framer-rdx5i6 > * { margin: 0px; margin-left: calc(0px / 2); margin-right: calc(0px / 2); } .framer-6h060 .framer-8uhskj > *, .framer-6h060 .framer-jg76r1 > *, .framer-6h060 .framer-2rfnbn > *, .framer-6h060 .framer-azi4t8 > *, .framer-6h060 .framer-r1xwzv > * { margin: 0px; margin-left: calc(10px / 2); margin-right: calc(10px / 2); } .framer-6h060 .framer-iupoi7 > * { margin: 0px; margin-left: calc(16px / 2); margin-right: calc(16px / 2); } .framer-6h060 .framer-c7tmsx > * { margin: 0px; margin-bottom: calc(0px / 2); margin-top: calc(0px / 2); } .framer-6h060 .framer-c7tmsx > :first-child { margin-top: 0px; } .framer-6h060 .framer-c7tmsx > :last-child { margin-bottom: 0px; } }", ".framer-6h060.framer-v-1win52g .framer-azi4t8 { cursor: pointer; }", ...css2, ...css3, ...css, '.framer-6h060[data-border="true"]::after, .framer-6h060 [data-border="true"]::after { content: ""; border-width: var(--border-top-width, 0) var(--border-right-width, 0) var(--border-bottom-width, 0) var(--border-left-width, 0); border-color: var(--border-color, none); border-style: var(--border-style, none); width: 100%; height: 100%; position: absolute; box-sizing: border-box; left: 0; top: 0; border-radius: inherit; pointer-events: none; }'];
var FramerLPvlGYrGE = withCSS(Component, css4, "framer-6h060");
var LPvlGYrGE_default = FramerLPvlGYrGE;
FramerLPvlGYrGE.displayName = "social proof";
FramerLPvlGYrGE.defaultProps = {
  height: 468,
  width: 1024
};
addPropertyControls2(FramerLPvlGYrGE, {
  variant: {
    options: ["hbrEbixPO", "Tc9JFPlP7"],
    optionTitles: ["Variant 1", "Variant 2"],
    title: "Variant",
    type: ControlType3.Enum
  }
});
addFonts(FramerLPvlGYrGE, [{
  explicitInter: true,
  fonts: [{
    family: "Inter",
    source: "framer",
...
}, ...MaterialFonts, ...getFontsFromSharedStyle(fonts2), ...getFontsFromSharedStyle(fonts3), ...getFontsFromSharedStyle(fonts)], {
  ...
  "exports": {
    ...
    "default": {
      ...
      "annotations": {
        ...
        "framerCanvasComponentVariantDetails": '{"propertyName":"variant","data":{"default":{"layout":["fixed","fixed"]},"Tc9JFPlP7":{"layout":["fixed","fixed"]}}}'
      }
    },
    "__FramerMetadata__": {
      "type": "variable"
...
var _OriginalComponent = LPvlGYrGE_default;
function SocialproofWrapped(props) {
...
Object.assign(SocialproofWrapped, _OriginalComponent);
export {  __FramerMetadata__,  SocialproofWrapped as default   };