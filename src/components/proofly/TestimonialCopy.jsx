"use client"
// http-url:https://framerusercontent.com/modules/50Ky6vcGasJJJtGyUrTS/apccP8LARJUTlICYl9ls/nUCYRw_UV.js
import { jsx as _jsx3, jsxs as _jsxs } from "react/jsx-runtime";
import { addFonts, ComponentViewportProvider, cx, getFonts, getFontsFromSharedStyle, getLoadingLazyAtYPosition, Image, RichText, useComponentViewport, useLocaleInfo, useVariantState, withCSS } from "@proofly-framer/runtime";
...
var serializationHash = "framer-Dwi06";
var variantClassNames = {
  iKM7AIaRf: "framer-v-1yg43qy"
};
var transition1 = {
  damping: 60,
  delay: 0,
...
var Component = React3.forwardRef(function (props, ref) {
  ...
  return <LayoutGroup id={layoutId ?? defaultLayoutId}>{<Variants animate={variants} initial={false}>{<Transition value={transition1}>{_jsx3(motion2.div, {
          ...restProps,
          ...gestureHandlers,
          className: cx(serializationHash, ...sharedStyleClassNames, "framer-1yg43qy", className4, classNames),
          "data-border": true,
          ...
          children: _jsx3(motion2.div, {
            ...
            children: _jsxs(motion2.div, {
              className: "framer-rh3j3m",
              "data-framer-name": "content-txt",
              layoutDependency,
              layoutId: "h2Vxu6e09",
              children: [_jsx3(motion2.div, {
                className: "framer-kbv8jm",
                ...
                }} className="framer-iedllw" data-framer-name="Image" layoutDependency={layoutDependency} layoutId="wCsprZvDi" />
              }), _jsx3(motion2.div, {
                className: "framer-1gze2to",
                "data-framer-name": "Testimonial",
                layoutDependency,
                layoutId: "GfSAzzpcJ",
                children: <RichText __fromCanvasComponent className="framer-1e8hup8" data-framer-name="Supporting text" fonts={["Inter"]} layoutDependency={layoutDependency} layoutId="Y12KfOz0S" style={{
                  "--framer-paragraph-spacing": "18px"
                }} verticalAlignment="top" withExternalLayout>{<React3.Fragment>{_jsx3(motion2.h3, {
                ...
                className: "framer-1lml4ze",
                "data-framer-name": "author",
                layoutDependency,
                layoutId: "FEqJxBb5o",
                children: [_jsxs(motion2.div, {
                  className: "framer-dulkxr",
                  "data-framer-name": "author",
                  layoutDependency,
                  layoutId: "JR58YW8x9",
                  children: [<Image background={{
                  ...
                  }} className="framer-1qsyafr" data-framer-name="Persons" layoutDependency={layoutDependency} layoutId="uA3DS0TKn" style={{
                    borderBottomLeftRadius: 80,
                    borderBottomRightRadius: 80,
                    borderTopLeftRadius: 80,
                    borderTopRightRadius: 80
                  }} />, _jsxs(motion2.div, {
                    className: "framer-fq20lm",
                    "data-framer-name": "name",
                    layoutDependency,
                    layoutId: "LspW1KMis",
                    children: [<RichText __fromCanvasComponent className="framer-19m0sdt" data-framer-name="Heading5" fonts={["Inter"]} layoutDependency={layoutDependency} layoutId="AXlv3_7s8" style={{
                      "--framer-paragraph-spacing": "0px"
                        ...
                        })}</React3.Fragment>}</RichText>, <RichText __fromCanvasComponent className="framer-18u3grw" data-framer-name="Subtitle2" fonts={["Inter"]} layoutDependency={layoutDependency} layoutId="VyseGwtYf" style={{
                  ...
                  className: "framer-1xgz2ti",
                  "data-framer-name": "arrows",
                  layoutDependency,
                  layoutId: "xnJs1f9UB",
                  children: [_jsx3(motion2.div, {
                    className: "framer-m02gsw",
                    "data-border": true,
                    ...
                    children: <ComponentViewportProvider>{_jsx3(motion2.div, {
                        className: "framer-15nd6wz-container",
                        layoutDependency,
                        layoutId: "M8QREeyqV-container",
                        children: <Icon color="rgba(255, 255, 255, 0.5)" height="100%" iconSearch="Home" iconSelection="ArrowBack" iconStyle15="Filled" iconStyle2="Filled" iconStyle7="Filled" id="M8QREeyqV" layoutId="M8QREeyqV" mirrored={false} selectByList style={{
                          height: "100%",
                          width: "100%"
                        }} width="100%" />
                      })}</ComponentViewportProvider>
                  }), _jsx3(motion2.div, {
                    className: "framer-cmj9mz",
                    ...
                    children: <ComponentViewportProvider>{_jsx3(motion2.div, {
                        className: "framer-p7l5dc-container",
                        layoutDependency,
                        layoutId: "h8MMo4Rwt-container",
                        style: {
                          rotate: 180
                        },
                        children: <Icon color="var(--token-c043a581-21f0-4f3b-a91f-233b971f6cc2, rgb(36, 52, 62))" height="100%" iconSearch="Home" iconSelection="ArrowBack" iconStyle15="Filled" iconStyle2="Filled" iconStyle7="Filled" id="h8MMo4Rwt" layoutId="h8MMo4Rwt" mirrored={false} selectByList style={{
                          height: "100%",
                          width: "100%"
                        }} width="100%" />
                      })}</ComponentViewportProvider>
...
var css4 = ["@supports (aspect-ratio: 1) { body { --framer-aspect-ratio-supported: auto; } }", ".framer-Dwi06.framer-18e3yxs, .framer-Dwi06 .framer-18e3yxs { display: block; }", ".framer-Dwi06.framer-1yg43qy { align-content: center; align-items: center; display: flex; flex-direction: row; flex-wrap: nowrap; gap: 72px; height: 468px; justify-content: center; overflow: hidden; padding: 40px; position: relative; width: 1024px; will-change: var(--framer-will-change-override, transform); }", ".framer-Dwi06 .framer-3g009n { align-content: center; align-items: center; display: flex; flex: 1 0 0px; flex-direction: row; flex-wrap: nowrap; gap: 0px; height: 100%; justify-content: center; overflow: visible; padding: 0px; position: relative; width: 1px; }", ".framer-Dwi06 .framer-rh3j3m { align-content: flex-start; align-items: flex-start; display: flex; flex: 1 0 0px; flex-direction: column; flex-wrap: nowrap; height: 100%; justify-content: space-between; overflow: visible; padding: 0px; position: relative; width: 1px; }", ".framer-Dwi06 .framer-kbv8jm { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: min-content; justify-content: flex-start; overflow: visible; padding: 0px; position: relative; width: 100%; }", ".framer-Dwi06 .framer-iedllw { aspect-ratio: 8.108108108108109 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 19px); overflow: visible; position: relative; width: 150px; }", ".framer-Dwi06 .framer-1gze2to { align-content: flex-start; align-items: flex-start; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: min-content; justify-content: flex-start; overflow: visible; padding: 0px; position: relative; width: 100%; }", ".framer-Dwi06 .framer-1e8hup8 { flex: none; height: auto; position: relative; white-space: pre-wrap; width: 94%; word-break: break-word; word-wrap: break-word; }", ".framer-Dwi06 .framer-1lml4ze { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; height: min-content; justify-content: space-between; overflow: visible; padding: 0px; position: relative; width: 100%; }", ".framer-Dwi06 .framer-dulkxr { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 16px; height: min-content; justify-content: flex-start; overflow: visible; padding: 0px; position: relative; width: min-content; }", ".framer-Dwi06 .framer-1qsyafr { aspect-ratio: 1 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 60px); overflow: hidden; position: relative; width: 60px; will-change: var(--framer-will-change-override, transform); }", ".framer-Dwi06 .framer-fq20lm { align-content: flex-start; align-items: flex-start; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 0px; height: min-content; justify-content: flex-start; overflow: visible; padding: 0px; position: relative; width: min-content; }", ".framer-Dwi06 .framer-19m0sdt, .framer-Dwi06 .framer-18u3grw { flex: none; height: auto; position: relative; white-space: pre; width: auto; }", ".framer-Dwi06 .framer-1xgz2ti { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: min-content; justify-content: flex-end; overflow: hidden; padding: 0px; position: relative; width: min-content; z-index: 1; }", ".framer-Dwi06 .framer-m02gsw, .framer-Dwi06 .framer-cmj9mz { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: 48px; justify-content: center; overflow: hidden; padding: 0px; position: relative; width: 48px; will-change: var(--framer-will-change-override, transform); }", ".framer-Dwi06 .framer-15nd6wz-container, .framer-Dwi06 .framer-p7l5dc-container { flex: none; height: 24px; position: relative; width: 24px; }", "@supports (background: -webkit-named-image(i)) and (not (font-palette:dark)) { .framer-Dwi06.framer-1yg43qy, .framer-Dwi06 .framer-3g009n, .framer-Dwi06 .framer-kbv8jm, .framer-Dwi06 .framer-1gze2to, .framer-Dwi06 .framer-dulkxr, .framer-Dwi06 .framer-fq20lm, .framer-Dwi06 .framer-1xgz2ti, .framer-Dwi06 .framer-m02gsw, .framer-Dwi06 .framer-cmj9mz { gap: 0px; } .framer-Dwi06.framer-1yg43qy > * { margin: 0px; margin-left: calc(72px / 2); margin-right: calc(72px / 2); } .framer-Dwi06.framer-1yg43qy > :first-child, .framer-Dwi06 .framer-3g009n > :first-child, .framer-Dwi06 .framer-kbv8jm > :first-child, .framer-Dwi06 .framer-1gze2to > :first-child, .framer-Dwi06 .framer-dulkxr > :first-child, .framer-Dwi06 .framer-1xgz2ti > :first-child, .framer-Dwi06 .framer-m02gsw > :first-child, .framer-Dwi06 .framer-cmj9mz > :first-child { margin-left: 0px; } .framer-Dwi06.framer-1yg43qy > :last-child, .framer-Dwi06 .framer-3g009n > :last-child, .framer-Dwi06 .framer-kbv8jm > :last-child, .framer-Dwi06 .framer-1gze2to > :last-child, .framer-Dwi06 .framer-dulkxr > :last-child, .framer-Dwi06 .framer-1xgz2ti > :last-child, .framer-Dwi06 .framer-m02gsw > :last-child, .framer-Dwi06 .framer-cmj9mz > :last-child { margin-right: 0px; } .framer-Dwi06 .framer-3g009n > * { margin: 0px; margin-left: calc(0px / 2); margin-right: calc(0px / 2); } .framer-Dwi06 .framer-kbv8jm > *, .framer-Dwi06 .framer-1gze2to > *, .framer-Dwi06 .framer-1xgz2ti > *, .framer-Dwi06 .framer-m02gsw > *, .framer-Dwi06 .framer-cmj9mz > * { margin: 0px; margin-left: calc(10px / 2); margin-right: calc(10px / 2); } .framer-Dwi06 .framer-dulkxr > * { margin: 0px; margin-left: calc(16px / 2); margin-right: calc(16px / 2); } .framer-Dwi06 .framer-fq20lm > * { margin: 0px; margin-bottom: calc(0px / 2); margin-top: calc(0px / 2); } .framer-Dwi06 .framer-fq20lm > :first-child { margin-top: 0px; } .framer-Dwi06 .framer-fq20lm > :last-child { margin-bottom: 0px; } }", ...css2, ...css3, ...css, '.framer-Dwi06[data-border="true"]::after, .framer-Dwi06 [data-border="true"]::after { content: ""; border-width: var(--border-top-width, 0) var(--border-right-width, 0) var(--border-bottom-width, 0) var(--border-left-width, 0); border-color: var(--border-color, none); border-style: var(--border-style, none); width: 100%; height: 100%; position: absolute; box-sizing: border-box; left: 0; top: 0; border-radius: inherit; pointer-events: none; }'];
var FramernUCYRw_UV = withCSS(Component, css4, "framer-Dwi06");
var nUCYRw_UV_default = FramernUCYRw_UV;
FramernUCYRw_UV.displayName = "Testimonial Copy";
FramernUCYRw_UV.defaultProps = {
  height: 468,
  width: 1024
};
addFonts(FramernUCYRw_UV, [{
  explicitInter: true,
  fonts: [{
    family: "Inter",
    source: "framer",
...
var _OriginalComponent = nUCYRw_UV_default;
function TestimonialCopyWrapped(props) {
...
Object.assign(TestimonialCopyWrapped, _OriginalComponent);
export {  __FramerMetadata__,  TestimonialCopyWrapped as default   };