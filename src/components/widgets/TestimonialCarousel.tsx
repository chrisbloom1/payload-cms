...
/**
 * Default testimonials shown in the "What our members say" section
 * on the home page and /brands. Mirrors the live Bloom site exactly —
 * if the live site updates a quote/role/headshot, update here too.
 */
