          ...
          <div className="mx-auto mt-12 grid max-w-4xl grid-cols-1 gap-3 sm:grid-cols-3">
            {heroQuickLinks.map(({ href, icon: Icon, label, description }) => (
              <Link
                key={href}
                href={href}
                className="group flex items-start gap-3 rounded-2xl border border-bloom-navy/10 bg-white p-5 shadow-bloom-card transition-all hover:border-bloom-navy/20 hover:shadow-md"
              >
