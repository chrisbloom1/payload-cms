      ...
      <main className="flex flex-col">
        ...
        <section className="w-full py-16 md:py-24">
          <div className="mx-auto w-full max-w-[1280px] px-4 sm:px-6">
            <div className="overflow-hidden rounded-3xl bg-gradient-to-br from-white via-white to-bloom-cream p-8 shadow-bloom-card ring-1 ring-bloom-navy/5 sm:p-10 lg:p-16">
